...
UPDATE accounts SET account_balance=10.0 WHERE transactions_attempted=0 AND account_balance=0;
...
-- 8 Add a new record.
INSERT INTO accounts(username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('ben', 'minneapolis', 10, 12, 130.00);
